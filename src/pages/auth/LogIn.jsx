...
//       localStorage.setItem("accessToken", token); // Store token for later use
...
//             className="w-full bg-gradient-to-r from-teal-500 to-orange-500 py-3 text-white font-semibold rounded"
