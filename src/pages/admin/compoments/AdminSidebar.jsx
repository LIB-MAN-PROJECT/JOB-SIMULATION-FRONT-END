...
const AdminSidebar = () => {
  ...
  const navLinks = [
    ...
    { name: "Companies", path: "/company-table", icon: <Building2 size={18} /> },
    { name: "Simulations", path: "/simulations", icon: <BookOpenCheck size={18} /> },
    { name: "Internships", path: "/internships", icon: <Briefcase size={18} /> },
    { name: "Certificates", path: "/certificates-issued", icon: <FileText size={18} /> },
  ...
  return (
    <>
      ...
      >
        <h2 className="text-xl font-bold mb-6 text-blue-600"><Link to="/admin">Admin Panel</Link></h2>
